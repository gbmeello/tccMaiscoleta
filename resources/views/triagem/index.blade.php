                ...
                "columns": [
                    ...
                    { "data": null , width: "100px", render: function(data, type, row) {
                            @php
                                ...
                                $editar = '<a href="'.url('triagem/editar').'/\' + data.pk_triagem + \'" class="btn btn-primary btn-flat btn-xs"><i class="fa fa-edit"></i> Editar</a>';
                                $deletar = '<button onclick="initializeDeleteDialog(&quot;triagem/deletar&quot;, \' + data.pk_triagem + \')" class="btn btn-danger btn-flat btn-xs"><i class="fa fa-trash"></i> Excluir</button>';
