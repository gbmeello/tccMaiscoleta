                ...
                { "data": null , width: "100px", render: function(data, type, row) {
                        ...
                        html += `
                            <div class="btn-group" role="group" aria-label="...">
                                <a href="{{ url('rota/editar/') }}/${data.pk_rota}" class="btn btn-primary btn-flat btn-xs"><i class="fa fa-edit"></i> Editar</a>
                                <button onclick="initializeDeleteDialog('rota/deletar', ${data.pk_rota})" class="btn btn-danger btn-flat btn-xs"><i class="fa fa-trash"></i> Excluir</button>
                            </div>`;
                        return html;
                    },
                    "targets": -1,
