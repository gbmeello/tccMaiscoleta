...
@section('contentHeader')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Cliente Final</li>
    </ol>
@endsection
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-centered">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Lista de Clientes Finais</h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    </div>
                    <div class="clearfix"></div>
                    <a href="{{url('/cliente-final/cadastrar')}}" class="btn btn-primary btn-sm" style="margin-top: 10px;">
                    <i class="fa fa-user-plus"></i> Cadastrar novo
                    </a>
                </div>
                <div class="box-body">
                    <table id="table-cliente-final" class="table table-bordered table-striped dataTable">
                        <thead>
                            <tr>
                                <th></th>
                                <th>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            let $table = $('#table-cliente-final');
            let dt = $table.DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{ url('api/v1/cliente-final/listar') }}",
                "columns": [
                    {
