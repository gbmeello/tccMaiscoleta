            ...
            "columns": [
                ...
                { "data": null , width: "100px", render: function(data, type, row) {
                        ...
                        @php
                            ...
                            $editar = '<a href="'.url('coleta/editar').'/\' + data.pk_coleta + \'" class="btn btn-primary btn-flat btn-xs"><i class="fa fa-edit"></i> Editar</a>';
                            $deletar = '<button onclick="initializeDeleteDialog(&quot;coleta/deletar&quot;, \' + data.pk_coleta + \')" class="btn btn-danger btn-flat btn-xs"><i class="fa fa-trash"></i> Excluir</button>';
