                    ...
                    { "data": null , width: "100px", render: function(data, type, row) {
                        ...
                        html += `
                                <div class="btn-group" role="group" aria-label="...">
                                    <a href="{{url('fardo/editar')}}/${data.pk_fardo}" class="btn btn-primary btn-flat btn-xs"><i class="fa fa-edit"></i> Editar</a>
                                    <button onclick="initializeDeleteDialog('fardo/deletar', ${data.pk_fardo})" class="btn btn-danger btn-flat btn-xs"><i class="fa fa-trash"></i> Excluir</button>
                                </div>`;
                        return html;
                        },
                        "targets": -1,
