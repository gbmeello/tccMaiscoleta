...
function Datepicker() {
	...
	this._defaults = { // FuncoesGlobais defaults for all the date picker instances
 ...
 * FuncoesGlobais datepicker_instActive, set by _updateDatepicker allows the handlers to find their way back to the active picker.
 */
