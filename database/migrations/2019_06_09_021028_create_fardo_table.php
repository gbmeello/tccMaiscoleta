...
class CreateFardoTable extends Migration
{
    ...
    public function up()
    {
        ...
        $schema->create('fardo', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('fk_triagem')->comment('Chave estrangeira vinda da tabela Triagem');
            $table->integer('lote')->comment('Lote do Fardo');
            $table->timestamp('data_venda')->comment('Data da venda do Fardo');
